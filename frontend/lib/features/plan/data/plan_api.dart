...
class PlanApi {
  ...
  Future<ApiResponse<Map<String, dynamic>>> generate(Map<String, dynamic> body) async {
  ...
  Future<ApiResponse<List<dynamic>>> getHistory(Map<String, dynamic> query) async {
    final resp = await _dio.get('${ApiEndpoints.dailyPlans}/history', queryParameters: query);
    return ApiResponse.fromJson(resp.data, null);
  }
