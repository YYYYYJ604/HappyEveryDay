...
class InterestApi {
  ...
  Future<ApiResponse<Map<String, dynamic>>> updateLevel(String interestId, Map<String, dynamic> body) async {
    final resp = await _dio.put('${ApiEndpoints.interests}/user/${interestId}/level', data: body);
    return ApiResponse.fromJson(resp.data, null);
  }

  /// GET /interests/:interestId/tasks
  Future<ApiResponse<List<dynamic>>> getTasks(String interestId, Map<String, dynamic> query) async {
    final resp = await _dio.get('${ApiEndpoints.interests}/${interestId}/tasks', queryParameters: query);
    return ApiResponse.fromJson(resp.data, null);
  }

  /// GET /interests/tasks/recommended
  Future<ApiResponse<List<dynamic>>> getRecommendedTasks(Map<String, dynamic> query) async {
    final resp = await _dio.get(ApiEndpoints.interestTasks, queryParameters: query);
    return ApiResponse.fromJson(resp.data, null);
  }

  /// GET /interests/growth/mine
  Future<ApiResponse<List<dynamic>>> getGrowthRecords(Map<String, dynamic> query) async {
    final resp = await _dio.get(ApiEndpoints.interestGrowth, queryParameters: query);
    return ApiResponse.fromJson(resp.data, null);
  }

  /// GET /interests/growth/monthly-summary
  Future<ApiResponse<Map<String, dynamic>>> getMonthlySummary(int? year, int? month) async {
    final resp = await _dio.get(ApiEndpoints.interestMonthlySummary, queryParameters: {
