...
class ActivityApi {
  ...
  Future<ApiResponse<List<dynamic>>> getByInterest(
    String interestId,
    Map<String, dynamic> query,
  ) async {
    final resp = await _dio.get(
      '${ApiEndpoints.activities}/interest/$interestId',
      queryParameters: query,
    );
    return ApiResponse.fromJson(resp.data, null);
  }
  ...
  Future<ApiResponse<Map<String, dynamic>>> completeCheckin(
    String id,
    Map<String, dynamic> body,
  ) async {
    final resp = await _dio.put(
      '${ApiEndpoints.activities}/$id/checkin',
      data: body,
    );
    return ApiResponse.fromJson(resp.data, null);
  }
  ...
  Future<ApiResponse<List<dynamic>>> getMyCheckins(
    Map<String, dynamic> query,
  ) async {
    final resp = await _dio.get(
      '${ApiEndpoints.activities}/checkins/mine',
      queryParameters: query,
    );
    return ApiResponse.fromJson(resp.data, null);
  }
  ...
  Future<ApiResponse<Map<String, dynamic>>> bookmark(
    String id,
    Map<String, dynamic>? body,
  ) async {
    final resp = await _dio.post(
      '${ApiEndpoints.activities}/$id/bookmark',
      data: body,
    );
    return ApiResponse.fromJson(resp.data, null);
  }
  ...
  Future<ApiResponse<List<dynamic>>> getMyBookmarks(
    Map<String, dynamic> query,
  ) async {
    final resp = await _dio.get(
      '${ApiEndpoints.activities}/bookmarks/mine',
      queryParameters: query,
    );
    return ApiResponse.fromJson(resp.data, null);
  }
  ...
  Future<ApiResponse<Map<String, dynamic>>> getBookmarkStatus(String id) async {
    final resp = await _dio.get(
      '${ApiEndpoints.activities}/$id/bookmark-status',
    );
    return ApiResponse.fromJson(resp.data, null);
  }
}
