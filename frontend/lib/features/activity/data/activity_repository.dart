...
abstract class ActivityRepository {
  ...
  Future<PaginatedResponse<ActivityModel>> getByInterest(
    String interestId,
    ActivityQueryParams params,
  );
  ...
  Future<PaginatedResponse<CheckinModel>> getMyCheckins(
    CheckinQueryParams params,
  );
...
class ActivityRepositoryImpl implements ActivityRepository {
  ...
  @override
  Future<PaginatedResponse<ActivityModel>> getAll(
    ActivityQueryParams params,
  ) async {
