...
class DioClient {
  ...
  static DioClient get instance { _instance ??= DioClient._(); return _instance!; }
  ...
  Dio _createDio() {
    ...
    d.interceptors.addAll([_AuthInterceptor(), _LogInterceptor(), _ErrorInterceptor()]);
    return d;
  }
...
class _LogInterceptor extends Interceptor {
  @override
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) {
    if (AppConfig.isDebug) print('[API] \u2192 \ \');
    handler.next(options);
  }
  @override
